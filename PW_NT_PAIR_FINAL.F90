...
integer,parameter:: mxhb=100000,mxtype=10
...
nu=nu+1
!------------------------------------------------------------------------------
call HBOND(nu,nhb,nhp,hs,nd,ni,nf,nsit,mxhb,x,y,z,dx,dy,dz,al,rl,uu,h,hh)
enddo
enddo
!------------------------------------------------------------------------------
nt(:)=0.d0
...
write(*,*)'TOTAL DIFFERENT TYPE OF PAIR WITHIN HBOND CUT-OFF DIST========>',nhb
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
subroutine HBOND(nu,nhb,nh,hs,nd,ni,nf,ns,mxhb,x,y,z,dx,dy,dz,al,rl,uu,h,hh)
